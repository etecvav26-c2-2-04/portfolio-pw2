    ...
    <?php include 'navBar.php'; ?>
        ...
        <div class="card text-bg-ligth mb-4">
            ...
            <div class="card-body">
                ...
                <p class="card-text">
                 O <strong>OpenSSl</strong> funciona como o motor de segurança da internet: implementa os protocolos TLS/SSL para <strong>criar conexões seguras (HTTPS)</strong> entre seu navegador e sites, trancando os dados durante o envio, gerando certificados de autenticidade e gerenciando chaves de segurança.
        </div>
