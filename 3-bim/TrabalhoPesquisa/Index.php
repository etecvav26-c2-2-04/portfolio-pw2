...
<body >
    ...
    <div class="mx-auto card" style=" margin: 5%; width: 75%;">

        <div class="card-header">Resumo da Pesquisa</div>
        ...
        <div class="card-body">
            ...
            <p class="card-text">
                ...
                <ul>
                    <li> 
                        OpenSSL: Uma biblioteca robusta que fornece diversas funções de criptografia 
